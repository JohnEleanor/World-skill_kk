        ...
        <table class="table-collapse w-full">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="inline-block no-underline bg-black text-white text-sm py-2 px-3 rounded-lg">Edit</a>
                        <a href="#" class="inline-block no-underline bg-black text-white text-sm py-2 px-3 rounded-lg">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
