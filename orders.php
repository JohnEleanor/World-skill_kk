...
<body>
    ...
    <div class="container max-w-xl mx-auto text-left flex items-center flex-wrap">
        <h1>รายการสินค้าที่ได้สั่งซื้อ</h1>
        <table class="table-collapse w-full">
            <thead>
                <tr>
                    <th class="p-2 bg-grey-lightest">No</th>
                    <th class="p-2 bg-grey-lightest">Name</th>
                    <th class="p-2 bg-grey-lightest">Amount</th>
                    <th class="p-2 bg-grey-lightest">Price</th>
                    <th class="p-2 bg-grey-lightest">Total Price</th>
                    <th class="p-2 bg-grey-lightest">Seller</th>
                    <th class="p-2 bg-grey-lightest">Order Date</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <tr>
                    <td class="p-2 border-t border-grey-light"><?=$result['ItemsOrderedID']?></td>
                    <td class="p-2 border-t border-grey-light"><?=$result['Name']?></td>
                    <td class="p-2 border-t border-grey-light"><?=$result['Amount']?>2</td>
