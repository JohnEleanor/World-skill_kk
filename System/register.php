...
require_once 'config.php';
    ...
    if(isset($_POST['btnInsert'])){ 
        ...
        }elseif ($_POST['type'] == "" || $_POST['group'] == "" || $_POST['firstname'] == ""|| $_POST['lastname'] == ""|| $_POST['email'] == ""|| $_POST['phone'] == ""|| $_POST['address'] == ""|| $_POST['province'] == ""|| $_POST['district'] == ""|| $_POST['subdistrict'] == ""|| $_POST['zipcode'] == ""|| $_POST['password'] == ""){
            echo "<script type = text/javascript>alert('กรุณากรอกข้อมูลให้สำเร็จ');</script>";
            header('Refresh:0 ../index.php');
        }else{
